      ...
      <div className="relative mx-auto max-w-[1600px] px-6 pb-10 pt-20 md:px-12">
        <div className="grid grid-cols-1 gap-16 md:grid-cols-12">
          ...
          <div className="md:col-span-3">
            ...
            <a href="mailto:contact@okiinc.global" data-testid="footer-email-link" className="mt-2 block text-sm text-oki-muted transition-colors duration-300 hover:text-oki-gold">
